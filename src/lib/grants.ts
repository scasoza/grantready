...
export const grants: Grant[] = [
  ...
  },
  {
    ...
    eligibility: "Nonprofit or public entities in rural areas (population under 20,000)",
    description:
      "Grants and low-interest loans for purchasing, constructing, or improving childcare facilities in communities with populations under 20,000. Only available to nonprofits, public bodies, and tribal governments.",
    tier: "growth",
    status: "open",
    difficulty: "Medium",
    recurring: false,
    criteria: { nonprofit: true, rural: true },
  },
  {
    id: 8,
  ...
  {
    id: 9,
    name: "Child Care Relief Fund (CCRF)",
    source: "Texas Workforce Commission",
    amount: "Varies by program cycle",
    deadline: "Check TWC for current availability",
    eligibility: "Licensed childcare providers in Texas",
    description:
      "State-administered stabilization and relief grants for licensed childcare providers. Helps cover operational costs, staffing, and facility needs during workforce shortages.",
    tier: "growth",
    status: "open",
    difficulty: "Easy",
    recurring: false,
  ...
  {
    id: 12,
    name: "Preschool Development Grant (PDG B-5) Sub-Grants",
    source: "Federal HHS / TWC",
    amount: "Varies — distributed through TWC initiatives",
    deadline: "State-administered cycles",
    eligibility: "Programs serving birth through age 5",
    description:
      "Federal systems-building grant awarded to the state. Individual providers may access sub-grants and quality improvement initiatives funded through PDG B-5 via TWC programs.",
    tier: "staff",
    status: "upcoming",
    difficulty: "Hard",
    recurring: false,
  ...
  // === PRIVATE FOUNDATIONS ===
  {
    ...
    amount: "Varies by project",
    deadline: "Rolling applications",
    eligibility: "Texas-based 501(c)(3) childcare organizations",
    description:
      "One of Texas' largest foundations. Funds educational programs, facility quality improvements, and staff training initiatives. Only awards to 501(c)(3) nonprofits and public entities.",
    tier: "foundation",
    status: "open",
    difficulty: "Medium",
    recurring: false,
    criteria: { nonprofit: true },
  },
  {
    id: 14,
    ...
    eligibility: "501(c)(3) providers in PNC service areas serving low-income children",
    description:
      "Funds curriculum development, teacher training, and classroom resource purchases focused on school readiness for underserved children ages 0–5. Only awards to 501(c)(3) nonprofits.",
    tier: "foundation",
    status: "open",
    difficulty: "Medium",
    recurring: false,
    criteria: { nonprofit: true, servesUnder5: true },
  },
  {
    id: 15,
    ...
    amount: "Varies by project",
    deadline: "Rolling applications",
    eligibility: "501(c)(3) providers in Houston, Austin, or Huntsville areas",
    description:
      "Supports nonprofit initiatives that measurably improve child development outcomes in Harris County, Travis County, and Walker County.",
    tier: "foundation",
    status: "open",
    difficulty: "Medium",
    recurring: false,
    criteria: { nonprofit: true, metroAreas: ["Houston", "Austin"] },
  },
  {
    id: 16,
    ...
    eligibility: "Texas 501(c)(3) nonprofits serving children",
    description:
      "Funds education and health initiatives statewide and human services in the Fort Worth area. Only awards to 501(c)(3) nonprofits.",
    tier: "foundation",
    status: "open",
    difficulty: "Hard",
    recurring: false,
