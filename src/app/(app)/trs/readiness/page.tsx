...
> = {
  ...
  prep: { title: "Center Prep", icon: "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" },
  assessment: { title: "Self-Assessment", icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" },
};
  ...
  return (
    <div className="min-h-screen bg-warm-50 text-warm-900">
      ...
      <main className="mx-auto max-w-3xl px-4 py-6 sm:px-6 sm:py-8 space-y-6">
        ...
        {/* Checks by category */}
        {(["documents", "staff", "prep", "assessment", "consistency"] as const).map((cat) => {
